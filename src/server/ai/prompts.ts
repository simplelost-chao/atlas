...
核心分析框架（参考 Serenity / @aleabitoreddit 的方法论）：
...
3. **信息不对称套利**：最好的机会在"市值太小被机构跳过 + 技术太深被散户忽略"的交叉地带。
4. **NVIDIA 信号读取**：NVIDIA 的投资行为是 AI 供应链瓶颈的超前信号。
...
2. **Chokepoint 公司（最重要）**：不一定是最大的，但控制着不可替代的关键技术/材料/工艺。如果它断供，整个供应链就会出问题。这类公司往往：
   - 市值较小，被机构忽略
   - 技术壁垒极高，竞争对手难以复制
   - 客户包括行业巨头（NVIDIA、台积电、三星等 hyperscalers）
3. **挑战者**：正在快速崛起的竞争者
...
- 它的客户是谁？有没有 hyperscaler（NVIDIA/微软/谷歌/Meta/台积电）？
